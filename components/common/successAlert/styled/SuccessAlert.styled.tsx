...
flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 animate-slideRight
`

export const AlertSuccessFirstDiv = tw.div`
flex items-center justify-center w-12 bg-emerald-500
`
...
`
export const AlertCloseSvg = tw.svg`
