...
const Footer = () => {
  return (
    <footer className="bg-gray-100 dark:bg-gray-800 mt-20 static bottom-0">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <p className="text-md text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2023 KGA - Blockchain 8</p>
      <div className="grid grid-cols-3 divide-x divide-slate-500 sm:ml-auto sm:mt-0 mt-4">
      <Link href="https://github.com/ambious12" className="text-gray-400 flex items-center pl-5">
        <Icon icon="bi:github" />
        <span className="text-gray-500 ml-1 text-sm">Kim Hong Tae</span>
      </Link>
      <Link href="https://github.com/nazzzo" className="text-gray-400 flex items-center pl-3 pr-1">
        <Icon icon="bi:github" />
        <span className="text-gray-500 ml-1 text-sm">Kim Joo Hyung</span>
      </Link>
      <Link href="https://github.com/parkjonghwan22" className="text-gray-400 flex items-center pl-4">
        <Icon icon="bi:github" />
