...
import { SectionWrap, SectionA, Logo, CollectionName, Description, CollectionDatas } from "./styled/collectioninfo.styled";
            ...
            {collections.map((collection) => (
                <SectionWrap key={collection.address}>
                    ...
                    <SectionA>
                        ...
                        <CollectionDatas creatorFee={collection.creatorFee} totalVolume={0} floorPrice={0} follows={0} />
                    </SectionA>
                </SectionWrap>
            ))}
